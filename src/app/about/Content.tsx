...
export default function AboutContent() {
  ...
  return (
    <>
        ...
        <div className="container-custom py-16 md:py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl md:text-5xl font-black text-white mb-5 leading-tight">
              ...
              <br />
              <span className="text-blue-400">نقلتك في ايد امينة</span>
            </h1>
            <p className="text-blue-100/80 leading-relaxed text-lg mb-6 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-3">
              <Button size="lg" className="bg-blue-500 hover:bg-blue-600 text-white shadow-lg shadow-blue-500/30 gap-2" asChild>
      ...
      {/* Stats */}
      <section className="py-10 bg-blue-950 text-white relative overflow-hidden">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-blue-100/60 hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                <div className="h-14 w-14 rounded-2xl bg-blue-50 text-blue-700 flex items-center justify-center mb-5">
                  <Target className="h-7 w-7" />
                </div>
                <h2 className="text-xl font-bold text-blue-950 mb-3">رسالتنا</h2>
            ...
            <Card className="border-blue-100/60 hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                ...
                <h2 className="text-xl font-bold text-blue-950 mb-3">رؤيتنا</h2>
                <p className="text-slate-600 leading-relaxed">
      ...
      <section className="section-padding bg-blue-50/40">
        <div className="container-custom">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-blue-950 mb-3">القيم اللي بنشتغل بيها</h2>
          </div>
            ...
            {values.map((v, i) => {
              ...
              return (
                <motion.div key={v.title} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
                  <Card className="border-blue-100/60 text-center hover:shadow-md transition-shadow h-full bg-white">
                    <CardContent className="p-6">
                      <div className="h-14 w-14 rounded-2xl bg-blue-50 text-blue-700 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <h2 className="text-2xl md:text-3xl font-bold text-blue-950 text-center mb-10">رحلتنا</h2>
          <div className="max-w-2xl mx-auto space-y-8">
            {milestones.map((m, i) => (
              <motion.div key={i} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex gap-4 items-start">
                <div className="shrink-0 w-16 h-16 rounded-2xl bg-blue-700 text-white flex items-center justify-center font-bold text-lg shadow-lg shadow-blue-700/20">
                  {m.year}
                </div>
                <div className="pt-3">
      ...
      <section className="section-padding bg-blue-50/40">
        <div className="container-custom text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-blue-950 mb-4">ليه الناس بتختار مسك الختام؟</h2>
          <div className="max-w-3xl mx-auto grid sm:grid-cols-2 gap-4 mt-8">
            {[
              ...
              <motion.div key={item} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
                <div className="flex items-center gap-3 bg-white rounded-xl p-4 border border-blue-100/60 hover:shadow-md transition-shadow">
      ...
      <section className="section-padding bg-blue-950 text-white relative overflow-hidden">
        ...
        <div className="container-custom text-center space-y-6 relative">
          ...
          <p className="text-blue-200 max-w-md mx-auto">كلمنا دلوقتي واحنا هنرتب كل حاجة. عرض السعر مجاني والمعاينة ببلاش.</p>
