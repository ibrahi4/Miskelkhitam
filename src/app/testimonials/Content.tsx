          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {testimonials.map((item, index) => (
              <motion.div key={item.id} custom={index} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
                <Card className="h-full border-blue-100/60 transition-shadow hover:shadow-md">
                  <CardContent className="p-6">
                    ...
                    <div className="border-t border-blue-50 pt-4">
                      <div className="font-bold text-blue-950">{item.name}</div>
