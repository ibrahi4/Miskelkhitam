...
const contactInfo = [
  { icon: Phone, label: "اتصل بنا", value: siteConfig.phone, href: `tel:${siteConfig.phone}`, color: "bg-green-700", ltr: true },
  { icon: MessageCircle, label: "واتساب", value: "تواصل عبر واتساب", href: `https://wa.me/${siteConfig.whatsapp}`, color: "bg-green-500", ltr: false },
  { icon: Mail, label: "البريد الالكتروني", value: siteConfig.email, href: `mailto:${siteConfig.email}`, color: "bg-emerald-600", ltr: true },
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-bl from-green-950 via-green-900 to-green-800">
        ...
        <div className="container-custom py-16 md:py-20 text-center relative z-10">
          ...
          <p className="text-green-100/80 leading-relaxed md:text-lg max-w-2xl mx-auto">
            سواء محتاج عرض سعر او عندك استفسار، فريقنا جاهز يساعدك 24/7.
          </p>
        </div>
        <div className="absolute bottom-0 inset-x-0 h-12 bg-gradient-to-t from-[#FAFDF7] to-transparent" />
      </section>
            ...
            {contactInfo.map((item) => {
              ...
              return (
                <a
                  ...
                  className="group"
                >
                  <Card className="border-green-100/60 hover:shadow-lg hover:border-green-200 transition-all h-full">
                    <CardContent className="p-4 text-center space-y-2">
                      ...
                      <div className="font-bold text-green-950 text-xs line-clamp-1" dir={item.ltr ? "ltr" : undefined}>
                        {item.value}
                      </div>
                    </CardContent>
                  </Card>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-green-950 mb-3">اختار وسيلة التواصل اللي تريحك</h2>
                <p className="text-slate-600 leading-relaxed">
                  فريقنا متاح 24 ساعة. اتصل بينا، ابعت واتساب، او املا الفورم واحنا هنرد عليك في دقائق.
                </p>
              </div>

              <Card className="border-green-100/60 bg-white">
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href={`tel:${siteConfig.phone}`} className="text-lg font-bold text-green-950 hover:text-green-700" dir="ltr">
                        {siteConfig.phone}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-green-50">
                    ...
                    <div className="flex-1">
                      ...
                      <a href={`https://wa.me/${siteConfig.whatsapp}`} target="_blank" rel="noopener noreferrer" className="text-lg font-bold text-green-950 hover:text-green-600">
                        كلمنا الآن
                      </a>
                    </div>
                  </div>
                  ...
                  {siteConfig.email && (
                    <div className="flex items-center gap-3 pt-4 border-t border-green-50">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <a href={`mailto:${siteConfig.email}`} className="text-sm font-bold text-green-950 hover:text-emerald-600 line-clamp-1" dir="ltr">
                          {siteConfig.email}
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-green-50">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-bold text-green-950">24 ساعة / 7 ايام</div>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 pt-4 border-t border-green-50">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-bold text-green-950">{siteConfig.address}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            {/* Form Side */}
            <div>
              <Card className="border-green-100/60 bg-white shadow-lg">
                <CardContent className="p-6 md:p-8">
                  <div className="flex items-center gap-2 mb-6">
                    <div className="w-10 h-10 bg-green-700 text-white rounded-xl flex items-center justify-center">
                      <Send className="h-5 w-5" />
                    </div>
                    <div>
                      <h2 className="text-lg font-bold text-green-950">ارسل لنا رسالة</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button type="submit" disabled={loading} className="w-full gap-2 bg-green-600 text-white hover:bg-green-700 shadow-lg shadow-green-600/20" size="lg">
