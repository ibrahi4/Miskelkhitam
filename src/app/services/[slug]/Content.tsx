  ...
  return (
    <>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div>
                <h2 className="text-2xl font-bold text-blue-950 mb-4">عن الخدمة</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-blue-950 mb-4">مميزات الخدمة</h2>
            ...
            <div className="space-y-5">
              <Card className="border-blue-100/60 shadow-md">
                <CardContent className="p-6 space-y-4">
                  <h3 className="font-bold text-blue-950 text-lg">محتاج الخدمة دي؟</h3>
              ...
              <Card className="border-blue-100/60">
                <CardContent className="p-6 space-y-3">
                  <h3 className="font-bold text-blue-950">ليه مسك الختام؟</h3>
                  {[
      ...
      <section className="section-padding bg-blue-50/40">
        <div className="container-custom">
          <h2 className="text-2xl font-bold text-blue-950 mb-6 text-center">خدمات تانية ممكن تحتاجها</h2>
                  ...
                  <Link href={`/services/${s.slug}`}>
                    <Card className="group h-full border-blue-100/60 hover:shadow-lg hover:border-blue-200 transition-all cursor-pointer bg-white">
                      <div className="relative h-40 overflow-hidden rounded-t-xl">
                        ...
                        <div className="absolute bottom-3 right-3 w-10 h-10 bg-blue-600 text-white rounded-xl flex items-center justify-center">
                          <SIcon className="w-5 h-5" />
                        </div>
                      </div>
                      <CardContent className="p-4">
                        <h3 className="font-bold text-blue-950 group-hover:text-blue-700 transition-colors">{s.shortTitle}</h3>
      ...
      <section className="section-padding bg-blue-950 text-white">
        <div className="container-custom text-center space-y-6">
          ...
          <p className="text-blue-200 max-w-md mx-auto">كلمنا دلوقتي والمعاينة مجانية وعرض السعر فوري.</p>
