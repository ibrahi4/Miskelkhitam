...
export function VideosSection() {
  ...
  return (
    <section id="videos" className="section-padding bg-sky-50/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {videos.map((vid, i) => (
            <motion.div
              ...
              className="bg-white rounded-2xl overflow-hidden shadow-sm border border-sky-100"
            >
              <div className="relative aspect-video bg-slate-100">
                ...
                <div className="absolute bottom-3 right-3 flex gap-2">
                  <button
                    ...
                    className="w-10 h-10 bg-sky-500/90 hover:bg-sky-600 text-white rounded-full flex items-center justify-center backdrop-blur-sm transition-colors"
                    aria-label={playing[vid.id] ? "إيقاف" : "تشغيل"}
                  >
              ...
              <div className="p-4">
                <h3 className="font-bold text-sky-950">{vid.title}</h3>
